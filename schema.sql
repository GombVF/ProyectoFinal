...
CREATE TABLE empleados(
	...
	tipo_empleado ENUM('Ejecutivo', 'Analista', 'Coordinador', 'Jefe de área', 'Subdirector', 'Director') NOT NULL,
...
CREATE TABLE servicios(
	...
	CONSTRAINT servicio_UK UNIQUE (id_maquinas,id_empleados,id_tipos_servicios,fecha)
);
